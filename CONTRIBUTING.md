...
Please prefix the subject with `[PATCH problem]`.
...
send to the correct list cd into the repo and run:
    ...
    git config format.subjectPrefix 'PATCH problem'
...
[LICENSE]: https://git.sr.ht/~samwhited/problem/tree/master/LICENSE.md
